...
@class SharedPokemonStatistics, SharedPokemonMove, SharedPokemonCompanion, SharedPokemon, SharedPokemonRemoteMove, SharedPokemonRemoteSprites, SharedPokemonRemoteStat, SharedPokemonRemoteCompanion, SharedPokemonRemote, SharedPokemonRemoteMoveMoveSpecs, SharedPokemonRemoteMoveCompanion, SharedPokemonRemoteMoveMoveSpecsCompanion, SharedPokemonRemoteSpritesOther, SharedPokemonRemoteSpritesCompanion, SharedPokemonRemoteSpritesOtherDreamWorld, SharedPokemonRemoteSpritesOtherOfficialArtwork, SharedPokemonRemoteSpritesOtherCompanion, SharedPokemonRemoteSpritesOtherDreamWorldCompanion, SharedPokemonRemoteSpritesOtherOfficialArtworkCompanion, SharedPokemonRemoteStatStatSpecs, SharedPokemonRemoteStatCompanion, SharedPokemonRemoteStatStatSpecsCompanion, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;
...
- (instancetype)initWithId:(int32_t)id name:(NSString *)name imageUrl:(NSString *)imageUrl stats:(NSArray<SharedPokemonStatistics *> *)stats moves:(NSArray<SharedPokemonMove *> *)moves __attribute__((swift_name("init(id:name:imageUrl:stats:moves:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemon *)doCopyId:(int32_t)id name:(NSString *)name imageUrl:(NSString *)imageUrl stats:(NSArray<SharedPokemonStatistics *> *)stats moves:(NSArray<SharedPokemonMove *> *)moves __attribute__((swift_name("doCopy(id:name:imageUrl:stats:moves:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSString *imageUrl __attribute__((swift_name("imageUrl")));
@property (readonly) NSArray<SharedPokemonMove *> *moves __attribute__((swift_name("moves")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) NSArray<SharedPokemonStatistics *> *stats __attribute__((swift_name("stats")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Pokemon.Companion")))
@interface SharedPokemonCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonCompanion *shared __attribute__((swift_name("shared")));
- (SharedPokemon *)mock __attribute__((swift_name("mock()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Pokemon.Move")))
@interface SharedPokemonMove : SharedBase
- (instancetype)initWithName:(NSString *)name link:(NSString *)link __attribute__((swift_name("init(name:link:)"))) __attribute__((objc_designated_initializer));
- (SharedPokemonMove *)doCopyName:(NSString *)name link:(NSString *)link __attribute__((swift_name("doCopy(name:link:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Pokemon.Statistics")))
@interface SharedPokemonStatistics : SharedBase
- (instancetype)initWithName:(NSString *)name baseStat:(int32_t)baseStat link:(NSString *)link __attribute__((swift_name("init(name:baseStat:link:)"))) __attribute__((objc_designated_initializer));
- (SharedPokemonStatistics *)doCopyName:(NSString *)name baseStat:(int32_t)baseStat link:(NSString *)link __attribute__((swift_name("doCopy(name:baseStat:link:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedPokemonApi : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
*/
- (void)getPokemonId:(int32_t)id completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getPokemon(id:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote")))
@interface SharedPokemonRemote : SharedBase
- (instancetype)initWithId:(int32_t)id moves:(NSArray<SharedPokemonRemoteMove *> *)moves name:(NSString *)name sprites:(SharedPokemonRemoteSprites *)sprites stats:(NSArray<SharedPokemonRemoteStat *> *)stats __attribute__((swift_name("init(id:moves:name:sprites:stats:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemote *)doCopyId:(int32_t)id moves:(NSArray<SharedPokemonRemoteMove *> *)moves name:(NSString *)name sprites:(SharedPokemonRemoteSprites *)sprites stats:(NSArray<SharedPokemonRemoteStat *> *)stats __attribute__((swift_name("doCopy(id:moves:name:sprites:stats:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t id __attribute__((swift_name("id")));
@property (readonly) NSArray<SharedPokemonRemoteMove *> *moves __attribute__((swift_name("moves")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@property (readonly) SharedPokemonRemoteSprites *sprites __attribute__((swift_name("sprites")));
@property (readonly) NSArray<SharedPokemonRemoteStat *> *stats __attribute__((swift_name("stats")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.Companion")))
@interface SharedPokemonRemoteCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.Move")))
@interface SharedPokemonRemoteMove : SharedBase
- (instancetype)initWithMove:(SharedPokemonRemoteMoveMoveSpecs *)move __attribute__((swift_name("init(move:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteMoveCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteMove *)doCopyMove:(SharedPokemonRemoteMoveMoveSpecs *)move __attribute__((swift_name("doCopy(move:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedPokemonRemoteMoveMoveSpecs *move __attribute__((swift_name("move")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.MoveCompanion")))
@interface SharedPokemonRemoteMoveCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteMoveCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.MoveMoveSpecs")))
@interface SharedPokemonRemoteMoveMoveSpecs : SharedBase
...
@property (class, readonly, getter=companion) SharedPokemonRemoteMoveMoveSpecsCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteMoveMoveSpecs *)doCopyName:(NSString *)name url:(NSString *)url __attribute__((swift_name("doCopy(name:url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.MoveMoveSpecsCompanion")))
@interface SharedPokemonRemoteMoveMoveSpecsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteMoveMoveSpecsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.Sprites")))
@interface SharedPokemonRemoteSprites : SharedBase
- (instancetype)initWithOther:(SharedPokemonRemoteSpritesOther *)other __attribute__((swift_name("init(other:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteSpritesCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteSprites *)doCopyOther:(SharedPokemonRemoteSpritesOther *)other __attribute__((swift_name("doCopy(other:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedPokemonRemoteSpritesOther *other __attribute__((swift_name("other")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.SpritesCompanion")))
@interface SharedPokemonRemoteSpritesCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteSpritesCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.SpritesOther")))
@interface SharedPokemonRemoteSpritesOther : SharedBase
- (instancetype)initWithDreamWorld:(SharedPokemonRemoteSpritesOtherDreamWorld *)dreamWorld officialArtwork:(SharedPokemonRemoteSpritesOtherOfficialArtwork *)officialArtwork __attribute__((swift_name("init(dreamWorld:officialArtwork:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteSpritesOtherCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteSpritesOther *)doCopyDreamWorld:(SharedPokemonRemoteSpritesOtherDreamWorld *)dreamWorld officialArtwork:(SharedPokemonRemoteSpritesOtherOfficialArtwork *)officialArtwork __attribute__((swift_name("doCopy(dreamWorld:officialArtwork:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedPokemonRemoteSpritesOtherDreamWorld *dreamWorld __attribute__((swift_name("dreamWorld")));
@property (readonly) SharedPokemonRemoteSpritesOtherOfficialArtwork *officialArtwork __attribute__((swift_name("officialArtwork")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.SpritesOtherCompanion")))
@interface SharedPokemonRemoteSpritesOtherCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteSpritesOtherCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.SpritesOtherDreamWorld")))
@interface SharedPokemonRemoteSpritesOtherDreamWorld : SharedBase
- (instancetype)initWithFrontDefault:(NSString *)frontDefault __attribute__((swift_name("init(frontDefault:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteSpritesOtherDreamWorldCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteSpritesOtherDreamWorld *)doCopyFrontDefault:(NSString *)frontDefault __attribute__((swift_name("doCopy(frontDefault:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *frontDefault __attribute__((swift_name("frontDefault")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.SpritesOtherDreamWorldCompanion")))
@interface SharedPokemonRemoteSpritesOtherDreamWorldCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteSpritesOtherDreamWorldCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.SpritesOtherOfficialArtwork")))
@interface SharedPokemonRemoteSpritesOtherOfficialArtwork : SharedBase
- (instancetype)initWithFrontDefault:(NSString *)frontDefault __attribute__((swift_name("init(frontDefault:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteSpritesOtherOfficialArtworkCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteSpritesOtherOfficialArtwork *)doCopyFrontDefault:(NSString *)frontDefault __attribute__((swift_name("doCopy(frontDefault:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *frontDefault __attribute__((swift_name("frontDefault")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.SpritesOtherOfficialArtworkCompanion")))
@interface SharedPokemonRemoteSpritesOtherOfficialArtworkCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteSpritesOtherOfficialArtworkCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.Stat")))
@interface SharedPokemonRemoteStat : SharedBase
- (instancetype)initWithBaseStat:(int32_t)baseStat stat:(SharedPokemonRemoteStatStatSpecs *)stat __attribute__((swift_name("init(baseStat:stat:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteStatCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteStat *)doCopyBaseStat:(int32_t)baseStat stat:(SharedPokemonRemoteStatStatSpecs *)stat __attribute__((swift_name("doCopy(baseStat:stat:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) int32_t baseStat __attribute__((swift_name("baseStat")));
@property (readonly) SharedPokemonRemoteStatStatSpecs *stat __attribute__((swift_name("stat")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.StatCompanion")))
@interface SharedPokemonRemoteStatCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteStatCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.StatStatSpecs")))
@interface SharedPokemonRemoteStatStatSpecs : SharedBase
- (instancetype)initWithName:(NSString *)name url:(NSString *)url __attribute__((swift_name("init(name:url:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPokemonRemoteStatStatSpecsCompanion *companion __attribute__((swift_name("companion")));
- (SharedPokemonRemoteStatStatSpecs *)doCopyName:(NSString *)name url:(NSString *)url __attribute__((swift_name("doCopy(name:url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonRemote.StatStatSpecsCompanion")))
@interface SharedPokemonRemoteStatStatSpecsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPokemonRemoteStatStatSpecsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonSharedRemoteSource")))
@interface SharedPokemonSharedRemoteSource : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonSharedRepo")))
@interface SharedPokemonSharedRepo : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchPokemonsTeamWithCompletionHandler:(void (^)(NSArray<SharedPokemon *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchPokemonsTeam(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPokemonByIdPokemonId:(int32_t)pokemonId completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("getPokemonById(pokemonId:completionHandler:)")));
@end

@interface SharedPokemonRemote (Extensions)
- (SharedPokemon *)toDomain __attribute__((swift_name("toDomain()")));
@end
