...
@class SharedPokemonStatistics, SharedPokemonMove, SharedPokemonCompanion, SharedPokemon, SharedPokemonRemoteMove, SharedPokemonRemoteSprites, SharedPokemonRemoteStat, SharedPokemonRemoteCompanion, SharedPokemonRemote, SharedPokemonRemoteMoveMoveSpecs, SharedPokemonRemoteMoveCompanion, SharedPokemonRemoteMoveMoveSpecsCompanion, SharedPokemonRemoteSpritesOther, SharedPokemonRemoteSpritesCompanion, SharedPokemonRemoteSpritesOtherDreamWorld, SharedPokemonRemoteSpritesOtherCompanion, SharedPokemonRemoteSpritesOtherDreamWorldCompanion, SharedPokemonRemoteStatStatSpecs, SharedPokemonRemoteStatCompanion, SharedPokemonRemoteStatStatSpecsCompanion, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedPlatform, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_coroutines_coreCoroutineScope, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinCoroutineContext, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
- (instancetype)initWithDreamWorld:(SharedPokemonRemoteSpritesOtherDreamWorld *)dreamWorld __attribute__((swift_name("init(dreamWorld:)"))) __attribute__((objc_designated_initializer));
...
- (SharedPokemonRemoteSpritesOther *)doCopyDreamWorld:(SharedPokemonRemoteSpritesOtherDreamWorld *)dreamWorld __attribute__((swift_name("doCopy(dreamWorld:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchPokemonsTeamScope:(id<SharedKotlinx_coroutines_coreCoroutineScope>)scope completionHandler:(void (^)(NSArray<SharedPokemon *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchPokemonsTeam(scope:completionHandler:)")));
